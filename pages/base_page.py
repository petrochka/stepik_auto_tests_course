...
class BasePage:
    ...
    def go_to_basket(self):
        button = self.browser.find_element(*BasePageLocators.GO_T0_BASKET)
        button.click()
    ...
    def should_be_authorized_user(self):
        assert self.is_element_present(*BasePageLocators.USER_ICON), "User icon is not presented, unauthorised user"
